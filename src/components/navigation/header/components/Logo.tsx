...
export type LogoProps = NonNullable<IHeaderContext['logo']>;

const Logo: FC<LogoProps> = (logo) => {
  const { organisation, setLogo } = useContext<IHeaderContext>(HeaderContext);
  ...
  const { 'aria-label': ariaLabel = 'NHS' } = logo;
