...
describe('Pagination', () => {
  ...
  describe('Pagination.Link', () => {
    ...
    it('renders previous elements', () => {
      ...
      expect(container.querySelector('.nhsuk-icon__arrow-left')).toBeTruthy();
      expect(container.querySelector('.nhsuk-icon__arrow-right')).toBeFalsy();
    ...
    it('renders next elements', () => {
      ...
      expect(container.querySelector('.nhsuk-icon__arrow-left')).toBeFalsy();
      expect(container.querySelector('.nhsuk-icon__arrow-right')).toBeTruthy();
