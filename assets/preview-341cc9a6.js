import{s as _}from"./index-d475d2ea.js";import{d as k}from"./index-aa8430a9.js";var p="backgrounds";const{logger:M}=__STORYBOOK_MODULE_CLIENT_LOGGER__;var{document:s,window:h}=_,B=()=>h.matchMedia("(prefers-reduced-motion: reduce)").matches,S=(r,e=[],n)=>{if(r==="transparent")return"transparent";if(e.find(a=>a.value===r))return r;let t=e.find(a=>a.name===n);if(t)return t.value;if(n){let a=e.map(i=>i.name).join(", ");M.warn(k`
...
//# sourceMappingURL=preview-341cc9a6.js.map
